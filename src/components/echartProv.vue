 ...
 * @LastEditTime: 2021-09-07 16:43:30
 * @LastEditors: long_jj
 * @Description: 
 * @FilePath: \vue-template-demo-master\src\components\echartProv.vue
-->
<template>
  <div id="china_map_box">
    <div id="china_map_prov" ref="china_map_prov" style="width: 180px; height: 160px"></div>
  </div>
</template>
